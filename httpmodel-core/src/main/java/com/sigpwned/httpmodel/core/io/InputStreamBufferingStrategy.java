...
public interface InputStreamBufferingStrategy {
  ...
  public static InputStreamBufferingStrategy MEMORY = InputStreamBufferer::newMemoryInstance;

  public static InputStreamBufferingStrategy FILE = InputStreamBufferer::newFileInstance;
